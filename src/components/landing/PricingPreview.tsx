...
const PricingPreview = () => {
  ...
  const handlePlanClick = (plan: typeof plans[0]) => {
    // Navigate to specific plan pages for detailed selection
    ...
    <section className="relative py-28 overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            Order via Discord for instant setup.
          </motion.p>
        </motion.div>
            ...
            >
              ...
              {plan.popular && (
                <motion.div
                  ...
                  style={{
                    background: "linear-gradient(105deg, transparent 40%, hsl(160 100% 55% / 0.04) 50%, transparent 60%)",
              ...
              {plan.popular && (
                <motion.div
                  className="absolute -top-2.5 left-1/2 -translate-x-1/2 rounded-full bg-primary px-3 py-0.5 text-[8px] font-bold tracking-widest text-primary-foreground"
              ...
              <motion.div
                className="mb-3 inline-flex rounded-lg bg-primary/8 border border-primary/10 p-2 relative z-10"
              ...
              <div className="flex items-baseline gap-0.5 mb-4 relative z-10">
                <motion.span
                  className="font-extrabold text-2xl text-primary font-display"
              ...
              <ul className="space-y-2 mb-5 relative z-10">
                {plan.features.map((f, fi) => (
                  <motion.li
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: 0.4 + i * 0.08 + fi * 0.04, duration: 0.3 }}
                  >
                    <motion.div
                      initial={{ scale: 0 }}
                      whileInView={{ scale: 1 }}
                      viewport={{ once: true }}
                      transition={{ delay: 0.5 + i * 0.08 + fi * 0.04, type: "spring" }}
                    >
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="relative z-10">
                <Button
                  variant="outline"
                  size="sm"
                  className="w-full gap-1.5 text-[10px] font-semibold border-border/30 text-primary hover:bg-primary/5 rounded-lg"
              ...
              <motion.div
                ...
                style={{ background: "linear-gradient(90deg, transparent, hsl(160 100% 45% / 0.25), transparent)" }}
                initial={{ scaleX: 0 }}
