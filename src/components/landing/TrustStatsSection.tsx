...
const performanceData = [
  { name: "Mon", tps: 19.8, latency: 12 },
  { name: "Tue", tps: 19.9, latency: 11 },
  { name: "Wed", tps: 20, latency: 10 },
  { name: "Thu", tps: 19.7, latency: 13 },
  { name: "Fri", tps: 19.9, latency: 11 },
  { name: "Sat", tps: 20, latency: 9 },
  { name: "Sun", tps: 19.8, latency: 12 },
];

const stats = [
  { icon: Server, label: "Servers Deployed", value: 5000, suffix: "+" },
  { icon: Users, label: "Happy Customers", value: 3200, suffix: "+" },
  { icon: Shield, label: "DDoS Attacks Blocked", value: 12000, suffix: "+" },
  { icon: Clock, label: "Avg Uptime", value: 99.99, suffix: "%" },
  { icon: Zap, label: "Avg Deploy Time", value: 30, suffix: "s" },
  { icon: Globe, label: "Regions", value: 4, suffix: "" },
  { icon: Cpu, label: "CPU Cores Available", value: 512, suffix: "+" },
  { icon: Award, label: "5-Star Reviews", value: 850, suffix: "+" },
];
  ...
  return (
    <section className="relative py-28 overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        {/* Stats Grid */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-5xl mx-auto mb-16">
          {stats.map((stat, i) => (
            <motion.div
              key={stat.label}
            ...
            >
              ...
              <p className="font-extrabold text-xl text-foreground font-display">
